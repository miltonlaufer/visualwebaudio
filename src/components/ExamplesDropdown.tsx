...
const ExamplesDropdown: React.FC<ExamplesDropdownProps> = observer(
  ({ variant, onExampleSelect, onClose, className = '' }) => {
    ...
    useOnClickOutside(dropdownRef as React.RefObject<HTMLElement>, handleClickOutside)
