...
describe('LangChainService', () => {
  ...
  describe('system prompt', () => {
    it('should include detailed utility node information', () => {
      ...
      // Check that utility nodes are properly documented
      expect(systemPrompt).toContain('SliderNode')
      expect(systemPrompt).toContain('MidiToFreqNode')
      expect(systemPrompt).toContain('MIDI note numbers to frequencies')
      expect(systemPrompt).toContain('SliderNode → MidiToFreqNode → OscillatorNode.frequency')
      expect(systemPrompt).toContain('ADVANCED EFFECT PATTERNS')
      expect(systemPrompt).toContain('HANDLE NAMES FOR CONNECTIONS')
    })
  })
})
